...
namespace LineForge.Services
{
    public class ExportService
    {
        ...
        private string GenerateSVG(PaperSettings paperSettings, AlgorithmSettings algoSettings, TextSettings textSettings)
        {
            ...
            foreach (var path in paths)
            {
                svg.AppendLine($"<path d=\"{path}\" stroke=\"{ColorToHex(paperSettings.PenColor)}\" " +
                    $"fill=\"none\" stroke-width=\"{penProperties.LineWidth}mm\"/>");
            }
        ...
        private string GenerateGCode(PaperSettings paperSettings, AlgorithmSettings algoSettings, TextSettings textSettings)
        {
            ...
            gcode.AppendLine($"; Line width: {penProperties.LineWidth}mm");
            gcode.AppendLine($"; Pressure range: {penProperties.MinPressure}-{penProperties.MaxPressure}");
            ...
            gcode.AppendLine($"M280 P0 S{penProperties.MinPressure} ; Set initial pen pressure");
            ...
            foreach (var path in paths)
            {
                ...
                gcode.AppendLine($"M280 P0 S{penProperties.MinPressure} ; Pen up");
                ...
                gcode.AppendLine($"M280 P0 S{penProperties.MaxPressure} ; Pen down");
        ...
        public void Apply3DEffects()
        {
            ...
            _effects3DService.UpdateEffect(_previewService.GetCurrentImage(), _paperSettings);
